	...
	drawDiv_mousedown=function (event){
        ...
        $('.wz-draw_division').bind('mousemove', function (event) {
        ...
        $('.wz-draw_division').bind('mouseup', function(event) {
            $('.wz-draw_division').unbind('mousemove');
  ...
  var divisionDraw=function (){
    ...
    $('.wz-draw_division').bind('mousedown', drawDiv_mousedown)
}
